...
|Checkout effettuato| Pagina relativa alla visualizzazione di conferma di avvenuta vendita/acquisto, da parte di un utente customer, del carrello. | ![CarrelloPieno](images/gui/v1/cart/CheckoutEffettuato.png) |
