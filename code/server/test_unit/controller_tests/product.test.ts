...
const DAOmockRegisterProducts = jest
  .fn()
  .mockImplementation(() => Promise.resolve());
const DAOmockChangeProductQuantity = jest
  .fn()
  .mockImplementation(() => Promise.resolve(20));
const DAOmockSellProduct = jest
  .fn()
...
const DAOmockGetAvailableProducts = jest.fn((filterType, category, model) => {
  if (filterType === "category") {
    return Promise.resolve(
      mockProducts.filter((p) => p.category === category && p.quantity > 0)
    );
  } else if (filterType === "model") {
    return Promise.resolve(
      mockProducts.filter((p) => p.model === model && p.quantity > 0)
    );
  } else {
    return Promise.resolve(mockProducts.filter((p) => p.quantity > 0));
  }
});
const DAOmockDeleteAllProducts = jest
  .fn()
  .mockImplementation(() => Promise.resolve(true));
const DAOmockDeleteProduct = jest
  .fn()
  .mockImplementation(() => Promise.resolve(true));
...
describe("Unit tests for the ProductController class", () => {
  /* ********************************************** *
   *    Unit test for the registerProducts method   *
   * ********************************************** */
  describe("Unit tests for the registerProducts method", () => {
    test("It should register a product", async () => {
      ...
      expect(DAOmockRegisterProducts).toHaveBeenCalledWith(
        "model1",
        "Smartphone",
        10,
        "details",
  ...
  describe("Unit tests for the changeProductQuantity method", () => {
    test("It should change the quantity of a product", async () => {
      ...
      await expect(
        productController.changeProductQuantity("model1", 10, "2024-01-01")
      ).resolves.toBe(20);
      expect(DAOmockChangeProductQuantity).toHaveBeenCalledWith(
        "model1",
        10,
        "2024-01-01"
      );
    ...
    test("It should change the quantity of a product if the changeDate is not provided", async () => {
      ...
      await expect(
        productController.changeProductQuantity("model1", 10, null)
      ).resolves.toBe(20);
      expect(DAOmockChangeProductQuantity).toHaveBeenCalledWith(
        "model1",
        10,
    ...
    test("It should throw InvalidParametersError when model is not a string or is empty", async () => {
      ...
      await expect(
        productController.changeProductQuantity("", 10, "2024-01-01")
      ).rejects.toThrow(InvalidParametersError);
    ...
    test("It should throw InvalidParametersError when newQuantity is not a number or is not an integer or  is less than or equal to 0", async () => {
      ...
      await expect(
        productController.changeProductQuantity("model1", -1, "2024-01-01")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockChangeProductQuantity).not.toHaveBeenCalled();
      DAOmockChangeProductQuantity.mockClear();

      await expect(
        productController.changeProductQuantity("model1", 10.5, "2024-01-01")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockChangeProductQuantity).not.toHaveBeenCalled();
      DAOmockChangeProductQuantity.mockClear();
    });

    test("It should throw InvalidParametersError when changeDate is not a string", async () => {
      const productController = new ProductController();

      await expect(
        productController.changeProductQuantity("model1", 10, 123 as any)
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockChangeProductQuantity).not.toHaveBeenCalled();
      DAOmockChangeProductQuantity.mockClear();
    });
    ...
    test("It should throw InvalidParametersError when changeDate is not in 'YYYY-MM-DD' format or is not a date", async () => {
      ...
      await expect(
        productController.changeProductQuantity("model1", 10, "01-01-2024")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockChangeProductQuantity).not.toHaveBeenCalled();
      DAOmockChangeProductQuantity.mockClear();

      await expect(
        productController.changeProductQuantity("model1", 10, "pippo")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockChangeProductQuantity).not.toHaveBeenCalled();
      DAOmockChangeProductQuantity.mockClear();
    });
    ...
    test("It should throw ArrivalDateError when changeDate is in the future", async () => {
      ...
      await expect(
        productController.changeProductQuantity("model1", 10, "2034-01-01")
      ).rejects.toThrow(ArrivalDateError);
      expect(DAOmockChangeProductQuantity).not.toHaveBeenCalled();
      DAOmockChangeProductQuantity.mockClear();
    });
  ...
  describe("Unit tests for the sellProduct method", () => {
    test("It should sell a product", async () => {
      ...
      await expect(
        productController.sellProduct("model1", 10, "2024-01-01")
      ).resolves.toBe(9);
      expect(DAOmockSellProduct).toHaveBeenCalledWith(
        "model1",
        10,
        "2024-01-01"
      );
    ...
    test("It should sell a product if the sellingDate is not provided", async () => {
      ...
      await expect(
        productController.sellProduct("model1", 10, null)
      ).resolves.toBe(9);
    ...
    test("It should throw InvalidParametersError when model is not a string or is empty", async () => {
      ...
      await expect(
        productController.sellProduct("", 10, "2024-01-01")
      ).rejects.toThrow(InvalidParametersError);
    ...
    test("It should throw InvalidParametersError when quantity is not a number or is not an integer or  is less than or equal to 0", async () => {
      ...
      await expect(
        productController.sellProduct("model1", -1, "2024-01-01")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockSellProduct).not.toHaveBeenCalled();
      DAOmockSellProduct.mockClear();

      await expect(
        productController.sellProduct("model1", 10.5, "2024-01-01")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockSellProduct).not.toHaveBeenCalled();
      DAOmockSellProduct.mockClear();
    });
    ...
    test("It should throw InvalidParametersError when sellingDate is not in 'YYYY-MM-DD' format or is not a date", async () => {
      ...
      await expect(
        productController.sellProduct("model1", 10, "01-01-2024")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockSellProduct).not.toHaveBeenCalled();
      DAOmockSellProduct.mockClear();

      await expect(
        productController.sellProduct("model1", 10, "pippo")
      ).rejects.toThrow(InvalidParametersError);
      expect(DAOmockSellProduct).not.toHaveBeenCalled();
      DAOmockSellProduct.mockClear();
    });
    ...
    test("It should throw ArrivalDateError when sellingDate is in the future", async () => {
      ...
      await expect(
        productController.sellProduct("model1", 10, "2034-01-01")
      ).rejects.toThrow(ArrivalDateError);
      expect(DAOmockSellProduct).not.toHaveBeenCalled();
      DAOmockSellProduct.mockClear();
    });
  ...
  describe("Unit tests for the getProducts method", () => {
    test("It should get all products", async () => {
      ...
      await expect(
        productController.getProducts(null, null, null)
      ).resolves.toBe(mockProducts);
    ...
    test("It should get all products filtered by category", async () => {
      ...
      await expect(
        productController.getProducts("category", "Smartphone", null)
      ).resolves.toStrictEqual(
        mockProducts.filter((p) => p.category === "Smartphone")
      );
      expect(DAOmockGetProducts).toHaveBeenCalledWith(
        "category",
        "Smartphone",
        null
      );
    ...
    test("It should throw FiltersError when category is not one of the allowed values", async () => {
      ...
      await expect(
        productController.getProducts("category", "InvalidCategory", null)
    ...
    test("It should throw FiltersError when category is not provided", async () => {
      ...
      await expect(
        productController.getProducts("category", null, null)
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetProducts).not.toHaveBeenCalled();
      DAOmockGetProducts.mockClear();
    });
    ...
    test("It should get all products filtered by model", async () => {
      ...
      await expect(
        productController.getProducts("model", null, "model1")
      ).resolves.toStrictEqual(
        mockProducts.filter((p) => p.model === "model1")
      );
    ...
    test("It should throw FiltersError when model is not provided", async () => {
      ...
      await expect(
        productController.getProducts("model", null, null)
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetProducts).not.toHaveBeenCalled();
      DAOmockGetProducts.mockClear();
    });
    ...
    test("It should throw FiltersError when category is provided with model", async () => {
      ...
      await expect(
        productController.getProducts("model", "Smartphone", "model1")
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetProducts).not.toHaveBeenCalled();
      DAOmockGetProducts.mockClear();
    });
    ...
    test("It should throw FiltersError when model is empty", async () => {
      ...
      await expect(
        productController.getProducts("model", null, "")
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetProducts).not.toHaveBeenCalled();
      DAOmockGetProducts.mockClear();
    });
  ...
  describe("Unit tests for the getAvailableProducts method", () => {
    test("It should get all available products", async () => {
      ...
      await expect(
        productController.getAvailableProducts(null, null, null)
      ).resolves.toStrictEqual(mockProducts.filter((p) => p.quantity > 0));
      expect(DAOmockGetAvailableProducts).toHaveBeenCalledWith(
        null,
        null,
        null
      );
    ...
    test("It should get all available products grouped by category", async () => {
      ...
      await expect(
        productController.getAvailableProducts("category", "Smartphone", null)
      ).resolves.toStrictEqual(
        mockProducts.filter(
          (p) => p.category === "Smartphone" && p.quantity > 0
        )
      );
      expect(DAOmockGetAvailableProducts).toHaveBeenCalledWith(
        "category",
    ...
    test("It should get all available products grouped by model", async () => {
      ...
      await expect(
        productController.getAvailableProducts("model", null, "model1")
      ).resolves.toStrictEqual(
        mockProducts.filter((p) => p.model === "model1" && p.quantity > 0)
      );
      expect(DAOmockGetAvailableProducts).toHaveBeenCalledWith(
        "model",
        null,
    ...
    test("It should throw FiltersError when model is not provided", async () => {
      ...
      await expect(
        productController.getAvailableProducts("model", null, null)
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetAvailableProducts).not.toHaveBeenCalled();
      DAOmockGetAvailableProducts.mockClear();
    });
    ...
    test("It should throw FiltersError when category is provided with model", async () => {
      ...
      await expect(
        productController.getAvailableProducts("model", "Smartphone", "model1")
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetAvailableProducts).not.toHaveBeenCalled();
      DAOmockGetAvailableProducts.mockClear();
    });
    ...
    test("It should throw FiltersError when model is empty", async () => {
      ...
      await expect(
        productController.getAvailableProducts("model", null, "")
      ).rejects.toThrow(FiltersError);
      expect(DAOmockGetAvailableProducts).not.toHaveBeenCalled();
      DAOmockGetAvailableProducts.mockClear();
    });
  ...
  describe("Unit tests for the deleteProduct method", () => {
    test("It should delete a product", async () => {
      ...
      await expect(productController.deleteProduct("model1")).resolves.toBe(
        true
      );
    ...
    test("It should throw InvalidParametersError when model is not a string or is empty", async () => {
      ...
      await expect(productController.deleteProduct("")).rejects.toThrow(
        InvalidParametersError
      );
