...
describe("Unit test for the registerProducts route", () => {
  ...
  test("It should return 422 if model is empty", async () => {
    ...
    expect(ProductController.prototype.registerProducts).toHaveBeenCalledTimes(0);  // The error should be thrown before the method is called
  });
  ...
  test("It should return 409 if a model is already registered", async () => {
    ...
    const response = await request(app).post(baseURL + "/products").send(p1);
...
describe("Unit test for the changeProductQuantity route", () => {
  test("It should return 200", async () => {
    jest
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ quantity: 10, changeDate: "2024-01-01" });
    expect(response.status).toBe(200);
  ...
  test("It should return 404 if model is empty", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/ ").send({ quantity: 10, changeDate: "2024-01-01" });
    expect(response.status).toBe(404);
    expect(response.body).toEqual({ });

    expect(ProductController.prototype.changeProductQuantity).toHaveBeenCalledTimes(0);  // The error should be thrown before the method is called
  });
  ...
  test("It should return 422 if quantity is negative", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ quantity: -1, changeDate: "2024-01-01" });
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if quantity is zero", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ quantity: 0, changeDate: "2024-01-01" });
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if quantity is not an integer", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ quantity: 1.5, changeDate: "2024-01-01" });
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if quantity is not provided", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ changeDate: "2024-01-01" });
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if changeDate is in the future", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ quantity: 10, changeDate: "2025-01-01" });
    expect(response.status).toBe(400);
  ...
  test("It should return 422 if changeDate is formatted incorrectly", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1").send({ quantity: 10, changeDate: "01-01-2024" });
    expect(response.status).toBe(422);
    expect(response.body).toEqual({ "error": "Invalid parameters", "status": 422 });
...
/* ********************************************** *
  ...
  * ********************************************** */
describe("Unit test for the sellProduct route", () => {
  test("It should return 200", async () => {
    jest
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ quantity: 5, sellingDate: "2024-01-01" });
    expect(response.status).toBe(200);
  ...
  test("It should return 422 if model is empty", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/ /sell").send({ quantity: 5, sellingDate: "2024-01-01" });
    expect(response.status).toBe(422);
  });
  ...
  test("It should return 422 if quantity is negative", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ quantity: -1, sellingDate: "2024-01-01" });
    expect(response.status).toBe(422);
  });
  ...
  test("It should return 422 if quantity is zero", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ quantity: 0, sellingDate: "2024-01-01" });
    expect(response.status).toBe(422);
  });
  ...
  test("It should return 422 if quantity is not an integer", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ quantity: 1.5, sellingDate: "2024-01-01" });
    expect(response.status).toBe(422);
  });
  ...
  test("It should return 422 if quantity is not provided", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ sellingDate: "2024-01-01" });
    expect(response.status).toBe(422);
  });
  ...
  test("It should return 422 if sellingDate is in the future", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ quantity: 5, sellingDate: "2025-01-01" });
    expect(response.status).toBe(400);
    expect(response.body).toEqual({ "error": "Invalid date", "status": 400 });
  ...
  test("It should return 422 if sellingDate is formatted incorrectly", async () => {
    ...
    const response = await request(app).patch(baseURL + "/products/model1/sell").send({ quantity: 5, sellingDate: "01-01-2024" });
    expect(response.status).toBe(422);
    expect(response.body).toEqual({ "error": "Invalid parameters", "status": 422 });
...
/* ********************************************** *
  ...
  * ********************************************** */
describe("Unit test for the getProducts route", () => {
  test("It should return 200", async () => {
    jest
  ...
  test("It should return 200 if grouping is model", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=model&model=model1");
    expect(response.status).toBe(200);
  ...
  test("It should return 422 if grouping is invalid", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=invalid");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if category is not valid", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=category&category=invalid");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if grouping is null but category is not", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=&category=Smartphone");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if grouping is null but model is not", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=&model=model1");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if category is empty", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=category&category=");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if grouping is category but a model is provided", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=category&model=model1");
    expect(response.status).toBe(422);
    expect(response.body).toEqual({ "error": "Invalid filters", "status": 422 });
  ...
  test("It should return 422 if grouping is model but a category is provided", async () => {
    ...
    const response = await request(app).get(baseURL + "/products?grouping=model&category=Smartphone");
    expect(response.status).toBe(422);
    expect(response.body).toEqual({ "error": "Invalid filters", "status": 422 });
 ...
 * ********************************************** */
describe("Unit test for the getAvailableProducts route", () => {
  test("It should return 200", async () => {
    jest
  ...
  test("It should return 200 if grouping is model", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=model&model=model1");
    expect(response.status).toBe(200);
  ...
  test("It should return 422 if grouping is invalid", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=invalid");
    expect(response.status).toBe(422);

    expect(ProductController.prototype.getAvailableProducts).toHaveBeenCalledTimes(0);  // The error should be thrown before the method is called
  });
  ...
  test("It should return 422 if category is not valid", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=category&category=invalid");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if grouping is null but category is not", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=&category=Smartphone");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if grouping is null but model is not", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=&model=model1");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if category is empty", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=category&category=");
    expect(response.status).toBe(422);
  ...
  test("It should return 422 if model is empty", async () => {
    ...
    expect(ProductController.prototype.getAvailableProducts).toHaveBeenCalledTimes(1);  // The error should be thrown before the method is called
  });
  ...
  test("It should return 422 if grouping is category but a model is provided", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=category&model=model1");
    expect(response.status).toBe(422);
    expect(response.body).toEqual({ "error": "Invalid filters", "status": 422 });
  ...
  test("It should return 422 if grouping is model but a category is provided", async () => {
    ...
    const response = await request(app).get(baseURL + "/products/available?grouping=model&category=Smartphone");
    expect(response.status).toBe(422);
    expect(response.body).toEqual({ "error": "Invalid filters", "status": 422 });
 ...
 * *************************************** */
describe("Unit test for the deleteProduct route", () => {
  test("It should return 200", async () => {
    jest
  ...
  test("It should return 401 if the user is not an admin or manager", async () => {
    ...
    expect(ProductController.prototype.deleteProduct).toHaveBeenCalledTimes(0);  // The error should be thrown before the method is called
  });
});
 ...
 * *************************************** */
describe("Unit test for the deleteAllProducts route", () => {
  test("It should return 200", async () => {
    jest
  ...
  test("It should return 401 if the user is not an admin or manager", async () => {
    ...
    expect(ProductController.prototype.deleteAllProducts).toHaveBeenCalledTimes(0);  // The error should be thrown before the method is called
  });
});